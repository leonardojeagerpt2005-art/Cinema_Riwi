...
export function SeatSelector({ movie, user, onClose, onBookingSuccess }: SeatSelectorProps) {
          ...
          <div className="py-8 text-center flex flex-col items-center justify-center space-y-6">
            ...
            <div className="w-full max-w-md p-5 rounded-2xl text-left border border-white/6 bg-gradient-to-b from-black/60 to-slate-900/40 space-y-3">
              ...
              <div className="pt-2 border-t border-white/8 flex justify-between items-center text-sm">
                ...
                <span className="font-bold text-cyan-400 text-lg">${totalPrice.toFixed(2)} USD</span>
              </div>
            </div>
          ...
          <div>
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Duración: {movie.duration} • ${movie.price.toFixed(2)} por asiento</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/8">
              <div>
                ...
                <p className="text-lg font-bold text-cyan-400 mt-0.5">Total: ${totalPrice.toFixed(2)} USD</p>
              </div>
